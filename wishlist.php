            ...
            <div class="user_info">
                ...
                <div class="specify-container">
                    ...
                    <a href="wishlist.php" target="_self">
                        <div class="specify-content" style="background-color: dodgerblue">My Wishlist</div>
                    </a>
                </div>
            </div>
...
<div class="details-container">
            <div class="myorders">
                <h3 style="color:white">My Wishlist</h3><br>
                <?php
                ...
                <div class="order">
                    ...
                    <div class="order-content">
                        ...
                        <div class="content" style="margin-right:100px;position:relative;left:150px">'.$row2['pname'].'</div>
                    </div>
                    <div class="order-footer">
                        <span class="price">Price:₹'.$row2['price'].'</span>
                    </div>
                </div>';
                    }
                ?>
